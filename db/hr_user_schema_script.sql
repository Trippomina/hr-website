...
-- to revoke ownership:
REVOKE ALL PRIVILEGES ON ALL TABLES IN SCHEMA employee_schema FROM hr_employee_manager ;
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA employee_schema TO hr_employee_manager;
